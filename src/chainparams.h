...
#ifndef SHARKFUND_CHAIN_PARAMS_H
#define SHARKFUND_CHAIN_PARAMS_H
#include <memory>
#include "bignum.h"
#include "uint256.h"
 ...
 * Sharkfund system. There are three: the main network on which people trade goods
