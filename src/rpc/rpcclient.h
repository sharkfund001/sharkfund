...
#ifndef _SHARKFUNDRPC_CLIENT_H_
#define _SHARKFUNDRPC_CLIENT_H_ 1
...
/** Show help message for sharkfund-cli.
 ...
 *
 * @note the argument can be removed once sharkfund-cli functionality is removed from Dacrsd
 */
