...
#ifndef _SHARKFUNDRPC_SERVER_H_
#define _SHARKFUNDRPC_SERVER_H_ 1
...
/**
 * SHARKFUND RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern json_spirit::Value getsharkfundstate(const json_spirit::Array& params, bool fHelp);
