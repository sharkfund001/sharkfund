...
//						"1. \"address \"  (string, required) The Sharkfund address.\n"
//						"\nResult:\n"
//						"\"account info\"  (string) \n"
...
//		CSharkfundAddress address(params[0].get_str());
//		CKeyID keyid;
...
Value validateaddress(const Array& params, bool fHelp)
{
	if(fHelp || params.size() != 1)
		{
			throw runtime_error(
					 "isvalideaddess \"sharkfund address\"\n"
					 "\ncheck address is valide\n"
					 "\nArguments:\n"
					 "1. \"sharkfund address\"  (string, required) sharkfund address\n"
					 "\nResult:\n"
					 "\nExamples:\n"
