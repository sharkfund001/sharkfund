 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called Dacrs (http://www.sharkfundbi.net/),
 * which enables instant payments to anyone, anywhere in the world. Sharkfund uses peer-to-peer technology to operate
